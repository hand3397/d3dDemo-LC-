...
// 하나의 MeshGeometry 안에서 geometry의 하위 범위를 정의한다.
// 즉, 여러 개의 geometry가 하나의 vertex/index 버퍼에 저장될 때,
// 각 하위 geometry를 그리기 위해 필요한 offset 및 데이터를 제공한다.
// 이를 통해 책의 Figure 6.3에서 설명한 기법을 구현할 수 있다.
